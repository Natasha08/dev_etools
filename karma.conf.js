...
module.exports = function karmaConfig (config) {
  config.set({
    ...
    files: [
         ...
         'public/app.js',
         'public/common/javascripts/controller.js',
         ...
         'public/modules/egym/providers/egymService.js',
         'public/modules/egym/EgymController.js',
         'public/spec/services/authServiceSpec.js',
         'public/spec/services/efridgeServiceSpec.js',
         'public/spec/controllers/EfridgeControllerSpec.js',
         'public/spec/controllers/RegisterController.js',
         'public/spec/factories/efridgeFactorySpec.js',
         'public/spec/factories/loginFactorySpec.js',
